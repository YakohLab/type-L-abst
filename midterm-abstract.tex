...
\end{figure}
%% This is introduced to remove headers for each block, and increase the payload.
%% contation window
...
\item \textbf{Evaluation 2}, validated the multiuser performance of the protocol.
  Using two terminals with an esablished session, we verified that two terminals could simultaneously send/receive datum.
    \begin{figure}[tb]
    \centering
